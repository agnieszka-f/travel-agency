...
describe('Component TripSummary ', () => {
  ...
  it('should throw error without required props', () => {
   ...
   it('should render correct tags', () => {
    ...
    const component = shallow(<TripSummary tags={tableOfTags} id={'abc'} image={'image.jpg'} name={'ABCD'} cost={'1234'} days={5}/>);
  ...
  it('shouldnt render tags when table tags is empty or undefined', () => {	
    const component1 = shallow(<TripSummary id={'abc'} image={'image.jpg'} name={'ABCD'} cost={'1234'} days={5}/>);
	expect(component1.exists('.tags .tag')).toEqual(false);
	
	const component2 = shallow(<TripSummary tags={[]} id={'abc'} image={'image.jpg'} name={'ABCD'} cost={'1234'} days={5}/>);
